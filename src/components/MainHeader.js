                                        ...
                                        {isAuthenticated ?
                                            <Dropdown  className='khair' as={ButtonGroup}>
                                                ...
                                                <Dropdown.Menu>
                                                    ...
                                                    <Dropdown.Item><Link to='/Favorites' style={{'text-decoration': 'none','color':'black' ,'padding':'10px','font-size': 'large'}}>My Favorites</Link></Dropdown.Item>
 ...
 */}               
                <div class="centered" style={{ 'text-align': 'center' }}>
                   ...
                   <h3>Your Best Mate to BEAT the week.</h3> 
...
export default withAuth0(MainHeader);
